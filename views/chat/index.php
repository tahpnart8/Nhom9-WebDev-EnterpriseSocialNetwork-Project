...
.chat-sidebar-header { padding: 1.2rem 1rem 0.5rem; display: flex; justify-content: space-between; align-items: center; }
.chat-sidebar-header h4 { font-weight: 800; font-size: 1.5rem; margin: 0; color: var(--ms-text); letter-spacing: -0.5px; }
.btn-ms-circle { width: 36px; height: 36px; border-radius: 50%; background: var(--ms-gray-light); display: flex; align-items: center; justify-content: center; border: none; font-size: 1.1rem; color: var(--ms-text); transition: 0.2s; cursor: pointer; }
.btn-ms-circle:hover { background: #e4e6eb; }

.search-input-group { background: var(--ms-gray-light); border-radius: 50px; padding: 8px 16px; margin: 0 1rem 0.8rem; display: flex; align-items: center; gap: 8px; }
.search-input-group input { border: none; background: transparent; outline: none; font-size: 0.95rem; flex-grow: 1; color: var(--ms-text); }
.search-input-group input::placeholder { color: var(--ms-text-muted); }

.chat-filter-tabs { display: flex; gap: 8px; padding: 0 1rem 0.8rem; }
.chat-filter-tabs span { padding: 6px 12px; border-radius: 20px; font-size: 0.9rem; font-weight: 600; cursor: pointer; color: var(--ms-text-muted); transition: 0.2s; }
.chat-filter-tabs span:hover { background: var(--ms-gray-light); }
.chat-filter-tabs span.active { background: rgba(0, 132, 255, 0.1); color: var(--ms-blue); }

.chat-list { flex-grow: 1; overflow-y: auto; padding: 0.2rem 0.5rem; }
.chat-item { display: flex; align-items: center; gap: 12px; padding: 0.5rem; cursor: pointer; border-radius: 8px; margin-bottom: 2px; text-decoration: none; }
.chat-item:hover { background: var(--ms-gray-light); }
.chat-item.active { background: rgba(0, 132, 255, 0.05); }

.chat-avatar { width: 56px; height: 56px; border-radius: 50%; position: relative; background: var(--ms-gray-light); flex-shrink: 0; display: flex; align-items: center; justify-content: center; font-weight: bold; color: var(--ms-text); }
.chat-avatar img { width: 100%; height: 100%; border-radius: 50%; object-fit: cover; }
.chat-item.online .chat-avatar::after, .cr-avatar-wrapper.online::after { content: ''; position: absolute; bottom: 2px; right: 2px; width: 14px; height: 14px; background: #31a24c; border-radius: 50%; border: 2px solid #fff; }

.chat-item-info { flex-grow: 1; overflow: hidden; display: flex; flex-direction: column; justify-content: center; }
.chat-item-name { font-weight: 500; font-size: 0.95rem; margin: 0 0 2px; color: var(--ms-text); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.chat-item-name.unread-highlight { font-weight: 900 !important; color: #000 !important; }
.chat-item-preview { font-size: 0.85rem; color: var(--ms-text-muted); font-weight: 400; margin: 0; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.chat-item-preview.unread-highlight { color: #000 !important; font-weight: 900 !important; }

/* Nhóm Avatar */
.avatar-group-composite { position: relative; width: 56px; height: 56px; flex-shrink: 0; }
.avatar-group-composite img, .avatar-group-composite .avatar-placeholder { width: 38px; height: 38px; border-radius: 50%; border: 2px solid white; position: absolute; object-fit: cover; background: var(--ms-gray-light); display: flex; align-items: center; justify-content: center; font-size: 0.8rem; font-weight: bold; color: var(--ms-text-muted); }
.avatar-group-composite .av-1 { top: 0; right: 0; z-index: 2; }
.avatar-group-composite .av-2 { bottom: 0; left: 0; z-index: 1; }

/* Giữa */
.chat-main { flex-grow: 1; display: flex; flex-direction: column; min-width: 0; position: relative; }
.chat-main-header { padding: 0.5rem 1rem; border-bottom: 1px solid #e0e0e0; display: flex; align-items: center; justify-content: space-between; z-index: 10; box-shadow: 0 1px 2px rgba(0,0,0,0.02); }
.header-info-block { display: flex; align-items: center; gap: 10px; cursor: pointer; padding: 6px; border-radius: 8px; transition: 0.2s; text-decoration: none; }
.header-info-block:hover { background: var(--ms-gray-light); }
.chat-main-header .btn-ms-circle { background: transparent; color: var(--ms-blue); font-size: 1.4rem; padding: 0;}
.chat-main-header .btn-ms-circle:hover { background: var(--ms-gray-light); }

.chat-messages { flex-grow: 1; overflow-y: auto; padding: 1.5rem 1.5rem 0.5rem; display: flex; flex-direction: column; gap: 2px; }

/* Bubble Logic */
.msg-bubble-wrapper { display: flex; align-items: flex-end; gap: 8px; max-width: 65%; margin-bottom: 12px; }
.msg-mine-wrapper { align-self: flex-end; justify-content: flex-end; }
.msg-other-wrapper { align-self: flex-start; justify-content: flex-start; }

.msg-bubble { padding: 8px 12px; font-size: 0.95rem; line-height: 1.35; position: relative; word-wrap: break-word; }
.msg-mine { background: var(--ms-blue); color: white; border-radius: 18px; }
.msg-other { background: var(--ms-gray-bubble); color: var(--ms-text); border-radius: 18px; }

/* Dynamic borderRadius classes for PHP/JS */
.rad-top-right { border-top-right-radius: 4px !important; }
.rad-bot-right { border-bottom-right-radius: 4px !important; margin-bottom: 2px !important; }
.rad-top-left { border-top-left-radius: 4px !important; }
.rad-bot-left { border-bottom-left-radius: 4px !important; margin-bottom: 2px !important; }

.msg-sender-avatar { width: 28px; height: 28px; border-radius: 50%; object-fit: cover; flex-shrink: 0; visibility: hidden; }
.show-avatar .msg-sender-avatar { visibility: visible; }
.msg-time-tooltip { font-size: 0.7rem; color: var(--ms-text-muted); margin-top: 4px; display: none; }

.chat-input-bar { padding: 1rem; display: flex; gap: 12px; align-items: flex-end; }
.chat-input-utils { display: flex; gap: 4px; padding-bottom: 4px; }
.chat-input-utils button { width: 36px; height: 36px; border-radius: 50%; border: none; background: transparent; color: var(--ms-blue); display: flex; align-items: center; justify-content: center; font-size: 1.4rem; cursor: pointer; transition: 0.2s; }
.chat-input-utils button:hover { background: var(--ms-gray-light); }

.chat-input-wrapper { flex-grow: 1; background: var(--ms-gray-light); border-radius: 20px; display: flex; align-items: flex-end; padding: 2px 8px; min-height: 40px; }
.chat-input-wrapper input { flex-grow: 1; border: none; background: transparent; padding: 10px 8px; font-size: 0.95rem; outline: none; }
.chat-input-wrapper .btn-emoji { border: none; background: transparent; color: var(--ms-blue); font-size: 1.4rem; padding: 6px; cursor: pointer; }

#btnSendMsg { width: 40px; height: 40px; border-radius: 50%; border: none; background: transparent; color: var(--ms-blue); font-size: 1.5rem; display: flex; align-items: center; justify-content: center; cursor: pointer; transition: 0.2s; flex-shrink: 0; }
#btnSendMsg:hover { background: var(--ms-gray-light); }

/* Phải */
.chat-right-sidebar { width: 340px; border-left: 1px solid #e0e0e0; display: flex; flex-direction: column; background: #fff; flex-shrink: 0; transition: width 0.3s; overflow-y: auto; }
.chat-right-sidebar.hidden { width: 0; border: none; overflow: hidden; }
.cr-header { display: flex; flex-direction: column; align-items: center; padding: 1.5rem 1rem 1rem; }
.cr-avatar-wrapper { position: relative; margin-bottom: 0.5rem; cursor: pointer; }
.cr-avatar-xxl { width: 80px; height: 80px; border-radius: 50%; object-fit: cover; }
.cr-avatar-wrapper .overlay { position: absolute; inset: 0; background: rgba(0,0,0,0.3); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; opacity: 0; transition: 0.2s; }
.cr-avatar-wrapper:hover .overlay { opacity: 1; }

.cr-name { font-weight: 700; font-size: 1.1rem; color: var(--ms-text); margin: 0; text-align: center; }
.cr-status { font-size: 0.8rem; color: var(--ms-text-muted); margin-bottom: 1.2rem; }

.cr-actions { display: flex; gap: 1.5rem; justify-content: center; margin-bottom: 0.5rem; }
.cr-action-item { display: flex; flex-direction: column; align-items: center; gap: 6px; cursor: pointer; border: none; background: transparent; }
.cr-action-item .icon { width: 36px; height: 36px; border-radius: 50%; background: var(--ms-gray-light); display: flex; align-items: center; justify-content: center; font-size: 1.2rem; color: var(--ms-text); transition: 0.2s; }
.cr-action-item:hover .icon { background: #e4e6eb; }
.cr-action-item span { font-size: 0.75rem; color: var(--ms-text); font-weight: 500; }

.cr-section { padding: 0.5rem 1rem; }
.cr-menu-item { display: flex; align-items: center; justify-content: space-between; padding: 0.8rem; border-radius: 8px; cursor: pointer; transition: 0.2s; font-weight: 600; font-size: 0.95rem; color: var(--ms-text); }
.cr-menu-item:hover { background: var(--ms-gray-light); }
.cr-menu-item i { font-size: 1.2rem; margin-right: 12px; color: var(--ms-text); width: 20px; text-align: center;}
.cr-menu-item .content { flex-grow: 1; }

.chat-empty { display: flex; flex-direction: column; align-items: center; justify-content: center; flex-grow: 1; color: var(--ms-text-muted); background: var(--ms-bg); }
</style>
...
<div class="chat-layout">
    ...
    <div class="chat-sidebar">
        <div class="chat-sidebar-header">
            ...
            <div class="d-flex gap-2">
                ...
                <button class="btn-ms-circle" data-bs-toggle="modal" data-bs-target="#createGroupModal"><i class="bi bi-pencil-square"></i></button>
            </div>
        </div>
        ...
        <div class="chat-list" id="chatSidebarList">
            ...
            <a href="index.php?action=chat&conv_id=<?php echo $conv['id']; ?>" 
               ...
               data-unread="<?php echo $isUnread ? 'true' : 'false'; ?>"
               data-search-name="<?php echo htmlspecialchars(mb_strtolower($displayName)); ?>">
                ...
                <div class="chat-item-info">
                    <p class="chat-item-name <?php echo $unreadWeight; ?>"><?php echo htmlspecialchars($displayName); ?></p>
            ...
            <div id="globalSearchArea" style="display:none;">
                ...
                <a href="index.php?action=chat&with=<?php echo $u['id']; ?>" class="chat-item colleague-search-item" data-search-name="<?php echo htmlspecialchars(mb_strtolower($u['full_name'])); ?>">
                    <div class="chat-avatar">
    ...
    <div class="chat-main">
        ...
        <div class="chat-main-header">
            <?php 
                ...
                if (!$isGroup) {
                    $partner = null;
                    foreach($conversations as $c) { if($c['id'] == $activeConvId) { $partner = $c; break; } }
                    if ($partner) {
                        $displayHeaderName = $partner['partner_name'];
                        $displayHeaderAvatar = $partner['partner_avatar'];
                    } else if ($withUserId) {
                        foreach($allUsers as $au) { if($au['id'] == $withUserId) { $displayHeaderName = $au['full_name']; $displayHeaderAvatar = $au['avatar_url']; break; } }
                    }
                }
            ?>
            <div class="header-info-block" id="btnToggleRightSidebar">
                ...
                <div>
                    <h6 class="mb-0 fw-bold" style="color:var(--ms-text);"><?php echo htmlspecialchars($displayHeaderName); ?></h6>
            ...
            <div class="d-flex gap-1" style="color: var(--ms-blue);">
                ...
                <button class="btn-ms-circle d-none d-md-flex" id="btnToggleRightSidebar2" title="Thông tin về cuộc trò chuyện"><i class="bi bi-info-circle-fill"></i></button>
            </div>
        </div>
        ...
        <div class="chat-messages" id="chatMessages">
            ...
            foreach($activeMessages as $i => $msg): 
                ...
                $radClass = '';
                if ($isMine) {
                    if ($isConsecutivePrev) $radClass .= ' rad-top-right ';
                    if ($isConsecutiveNext) $radClass .= ' rad-bot-right ';
                } else {
                    if ($isConsecutivePrev) $radClass .= ' rad-top-left ';
                    if ($isConsecutiveNext) $radClass .= ' rad-bot-left ';
                }
            ?>
            <?php if(!$isMine && $isGroup && $showName): ?>
                <div class="w-100 mb-1"><a href="index.php?action=profile&id=<?php echo $msg['sender_id']; ?>" class="text-muted text-decoration-none" style="font-size:0.75rem; margin-left:36px; font-weight: 500; text-transform: capitalize;"><?php echo htmlspecialchars($msg['sender_name']); ?></a></div>
            <?php endif; ?>
            <div class="msg-bubble-wrapper <?php echo $isMine ? 'msg-mine-wrapper' : 'msg-other-wrapper'; ?> <?php echo $showAvatar ? 'show-avatar' : ''; ?> message-item" data-id="<?php echo $msg['id']; ?>">
                <?php if(!$isMine && $isGroup): ?>
                    <a href="index.php?action=profile&id=<?php echo $msg['sender_id']; ?>"><img src="<?php echo $msg['sender_avatar'] ?: 'https://placehold.co/32x32'; ?>" class="msg-sender-avatar" title="<?php echo htmlspecialchars($msg['sender_name']); ?>"></a>
                <?php endif; ?>
                ...
                ?>
                <div class="msg-bubble <?php echo $bubbleClass; ?> <?php echo $radClass; ?> <?php echo $isImageMatch ? 'bg-transparent p-0 shadow-none' : ''; ?>" title="<?php echo date('H:i', strtotime($msg['created_at'])); ?>">
                    <?php 
                        if ($isImageMatch) {
        ...
        <div class="chat-input-bar">
            <div class="chat-input-utils">
                ...
                <button title="Đính kèm ảnh/file" onclick="$('#chatImageFile').click()"><i class="bi bi-plus-circle-fill"></i></button>
                <button title="Gửi ảnh GIF" onclick="$('#chatInput').val('XIN CHÀO MỌI NGƯỜI !!!🥳').trigger('input');"><i class="bi bi-filetype-gif"></i></button>
            </div>
            ...
            <button id="btnSendMsg" title="Gửi"><i class="bi bi-send-fill d-none" id="sendIcon"></i><i class="bi bi-hand-thumbs-up-fill" id="likeIcon"></i></button>
        </div>
    ...
    <div class="chat-right-sidebar" id="rightSidebar">
        <div class="cr-header">
            <div class="cr-avatar-wrapper <?php echo (!$isGroup && rand(0,1)) ? 'online' : ''; ?>" id="btnGroupAvatarTrigger">
                <?php if($displayHeaderAvatar): ?>
                    <img src="<?php echo htmlspecialchars($displayHeaderAvatar); ?>" class="cr-avatar-xxl" id="previewGroupAvatar">
                <?php else: ?>
                    <div class="cr-avatar-xxl d-flex align-items-center justify-content-center bg-light text-muted fs-1 fw-bold"><?php echo mb_substr(trim($displayHeaderName),0,1,'UTF-8'); ?></div>
                <?php endif; ?>
                <?php if($isGroup): ?>
            ...
            <div class="cr-actions">
                ...
                <a href="index.php?action=profile&id=<?php echo $partner['partner_id']; ?>" class="cr-action-item text-decoration-none"><div class="icon"><i class="bi bi-person-circle"></i></div><span class="text-dark">Trang cá nhân</span></a>
                <?php endif; ?>
                <button class="cr-action-item" onclick="Swal.fire('Thành công', 'Đã tắt thông báo đoạn chat này!', 'success')"><div class="icon"><i class="bi bi-bell-slash-fill"></i></div><span>Tắt thông báo</span></button>
                <button class="cr-action-item" id="btnSearchConversation"><div class="icon"><i class="bi bi-search"></i></div><span>Tìm kiếm</span></button>
            </div>
        </div>
        ...
        <div class="cr-section">
            ...
            <div class="cr-menu-item" data-bs-toggle="collapse" data-bs-target="#groupCustomCollapse">
                <i class="bi bi-pencil-fill"></i><div class="content">Tùy chỉnh đoạn chat</div><i class="bi bi-chevron-down ms-auto" style="font-size:0.8rem;"></i>
            </div>
            <div class="collapse p-2" id="groupCustomCollapse">
                <input type="text" id="editGroupName" class="form-control form-control-sm mb-2" value="<?php echo htmlspecialchars($activeConv['name']); ?>" placeholder="Đổi tên nhóm">
                ...
                <?php endif; ?>
                <button class="btn btn-primary btn-sm w-100 rounded-pill" id="btnSaveGroupSettings">Lưu thay đổi</button>
            </div>
            
            <div class="cr-menu-item mt-2" data-bs-toggle="collapse" data-bs-target="#groupMembersCollapse">
                <i class="bi bi-people-fill"></i><div class="content">Thành viên trong đoạn chat</div><i class="bi bi-chevron-down ms-auto" style="font-size:0.8rem;"></i>
            </div>
            <div class="collapse p-2" id="groupMembersCollapse">
                <div class="d-flex mb-2">
                    <button class="btn btn-light btn-sm w-100 rounded-pill text-primary fw-bold" id="btnAddMemberToggle">+ Thêm người</button>
                </div>
                <!-- Box Thêm Người -->
                <div id="addMemberArea" style="display:none;" class="mb-3 p-2 bg-light rounded-3 border">
                    <select id="newMembersSelect" class="form-select form-select-sm mb-2" multiple style="height: 100px;">
                        <?php foreach($allUsers as $au): ?>
                            <option value="<?php echo $au['id']; ?>"><?php echo htmlspecialchars($au['full_name']); ?></option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="d-flex align-items-center gap-2 mb-2 p-1 rounded-3" style="cursor:pointer;" onmouseover="this.style.background='var(--ms-gray-light)'" onmouseout="this.style.background='transparent'">
                    <img src="<?php echo $gm['avatar_url'] ?: 'https://placehold.co/32x32'; ?>" class="rounded-circle" style="width:32px;height:32px;object-fit:cover;">
                    <div class="small flex-grow-1 fw-bold"><?php echo htmlspecialchars($gm['full_name']); ?>
                        <?php if($gm['role'] === 'admin'): ?><div class="text-muted fw-normal" style="font-size:0.7rem;">Quản trị viên</div><?php endif; ?>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
            ...
            <div class="cr-menu-item mt-2" data-bs-toggle="collapse" data-bs-target="#groupRequestsCollapse">
                <i class="bi bi-person-plus-fill"></i><div class="content">Yêu cầu tham gia</div><i class="bi bi-chevron-down ms-auto" style="font-size:0.8rem;"></i>
            </div>
            <div class="collapse p-2" id="groupRequestsCollapse">
                <div id="pendingRequestsArea"><p class="text-center text-muted py-2 small">Đang tải...</p></div>
            </div>
            <?php endif; ?>
            ...
            <div class="cr-menu-item mt-2" data-bs-toggle="collapse" data-bs-target="#groupMediaCollapse">
                <i class="bi bi-images"></i><div class="content">File & Bộ sưu tập</div><i class="bi bi-chevron-down ms-auto" style="font-size:0.8rem;"></i>
            </div>
        ...
        <div class="modal-content border-0 rounded-4 shadow">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <input type="text" id="groupNameInput" class="form-control rounded-3 bg-light" placeholder="Ví dụ: Hội nhóm vui vẻ">
                </div>
                <div class="mb-3">
                    ...
                    <div class="list-group list-group-flush rounded-3 border overflow-auto" style="max-height: 250px;">
                        <?php foreach($allUsers as $u): ?>
                        <?php if($u['id'] == $_SESSION['user_id']) continue; ?>
                        <label class="list-group-item d-flex align-items-center gap-3 py-2 cursor-pointer border-bottom-0">
                            <input class="form-check-input flex-shrink-0 group-member-check" type="checkbox" value="<?php echo $u['id']; ?>">
                            <img src="<?php echo $u['avatar_url'] ?: 'https://placehold.co/40x40'; ?>" class="rounded-circle" style="width:32px;height:32px;object-fit:cover;">
            ...
            <div class="modal-footer border-0 pt-0">
                ...
                <button type="button" class="btn btn-primary rounded-pill px-4 fw-bold" id="btnDoCreateGroup">Tạo ngay</button>
            </div>
        </div>
    </div>
</div>
