...
<div class="profile-container pb-5">
            ...
            <div class="profile-avatar-container">
                ...
                <?php else: ?>
                    <div class="d-flex align-items-center justify-content-center bg-primary text-white w-100 h-100"
                        style="font-size: 5rem; font-weight: 800;">
                        <?php
            ...
            <div class="row align-items-center" style="padding-left: 210px; min-height: 100px;">
                ...
                <div class="col-md-5">
                    ...
                    <div class="d-flex align-items-center gap-3 text-muted small mt-1">
                        ...
                        <span class="text-warning">🔥
                            <b><?php echo floor((time() - strtotime($user['created_at'])) / 86400); ?></b> ngày gắn
                            bó</span>
                        <?php if (!$isViewingSelf): ?>
                            <span class="badge bg-light text-dark border"><i class="bi bi-person-check me-1"></i> Đồng
                                nghiệp</span>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="col-md-4 border-start ps-4">
                    <div class="small text-secondary fw-medium">
                        <?php if (empty($user['hide_birthdate']) && !empty($user['birthdate'])): ?>
                            <div class="mb-1"><i class="bi bi-balloon-fill me-2 text-primary opacity-75"></i>Sinh nhật:
                                <?php echo date('d/m/Y', strtotime($user['birthdate'])); ?></div>
                        <?php endif; ?>
                        <?php if (!empty($user['location'])): ?>
                            <div class="mb-1"><i class="bi bi-geo-alt-fill me-2 text-danger opacity-75"></i>Sống tại:
                                <?php echo htmlspecialchars($user['location']); ?></div>
                        <?php endif; ?>
                    </div>
                    <div class="mt-2 d-flex gap-2">
                        <?php if (!empty($user['link_facebook'])): ?>
                            <a href="<?php echo htmlspecialchars($user['link_facebook']); ?>" target="_blank"
                                class="social-link-icon" title="Facebook"><i class="bi bi-facebook"></i></a>
                        <?php endif; ?>
                        <?php if (!empty($user['link_instagram'])): ?>
                            <a href="<?php echo htmlspecialchars($user['link_instagram']); ?>" target="_blank"
                                class="social-link-icon" title="Instagram"><i class="bi bi-instagram"></i></a>
                        <?php endif; ?>
                        <?php if (!empty($user['link_tiktok'])): ?>
                            <a href="<?php echo htmlspecialchars($user['link_tiktok']); ?>" target="_blank"
                                class="social-link-icon" title="TikTok"><i class="bi bi-tiktok"></i></a>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="col-md-3 text-end">
                    <div class="d-flex align-items-center justify-content-end gap-2">
                        <?php if ($isViewingSelf): ?>
                            <a href="index.php?action=social"
                                class="btn btn-primary rounded-pill fw-bold px-4 shadow-sm border-0"
                                style="background: linear-gradient(45deg, #0d6efd, #0b5ed7);">
                                <i class="bi bi-plus-lg me-1"></i>Đăng
                            </a>
                            <button type="button" onclick="handleOpenEditModal()" class="btn-edit-trigger shadow-sm"
                                title="Chỉnh sửa trang cá nhân">
                                <i class="bi bi-three-dots fs-5"></i>
                            </button>
                        <?php else: ?>
                            <a href="index.php?action=chat&with=<?php echo $user['id']; ?>"
                                class="btn btn-primary rounded-pill fw-bold px-4 shadow-sm border-0">
            ...
            <div class="row mt-4 pt-4 border-top g-3">
                <div class="col-md-3">
                    <div class="p-3 rounded-4 bg-light border-start border-primary border-4 shadow-sm">
                        <div class="text-uppercase small fw-bold text-muted mb-1" style="letter-spacing: 0.5px;">Tổng
                            công việc</div>
                        <div class="h3 fw-black mb-0 text-primary"><?php echo $performance['total_assigned'] ?? 0; ?>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="p-3 rounded-4 bg-light border-start border-success border-4 shadow-sm">
                        <div class="text-uppercase small fw-bold text-muted mb-1" style="letter-spacing: 0.5px;">Đã hoàn
                            thành</div>
                ...
                <div class="col-md-3">
                    <div class="p-3 rounded-4 bg-light border-start border-danger border-4 shadow-sm">
                        <div class="text-uppercase small fw-bold text-muted mb-1" style="letter-spacing: 0.5px;">Việc
                            trễ hạn</div>
                ...
                <div class="col-md-3">
                    <div class="p-3 rounded-4 bg-primary text-white shadow-sm position-relative overflow-hidden">
                        <div class="text-uppercase small fw-bold mb-1 opacity-75" style="letter-spacing: 0.5px;">Hiệu
                            suất (KPI)</div>
                        <div class="h3 fw-black mb-0"><?php echo $performance['efficiency_rate'] ?? 0; ?>%</div>
                        <i class="bi bi-graph-up-arrow position-absolute opacity-25"
                            style="font-size: 4rem; bottom: -10px; right: -5px;"></i>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="mt-4">
        <h5 class="fw-bold mb-4 d-flex align-items-center"><i class="bi bi-clock-history me-2 text-muted"></i>Lịch sử
            bài đăng</h5>
                        ...
                        <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                            <div class="card-header bg-white border-0 py-3 px-4 d-flex align-items-center">
                                <div style="width: 48px; height: 48px"
                                    class="rounded-circle overflow-hidden bg-light me-3 flex-shrink-0">
                                    <img src="<?php echo htmlspecialchars($post['avatar_url'] ?? 'https://placehold.co/100x100?text=Avatar'); ?>"
                                        class="w-100 h-100" style="object-fit:cover">
                                </div>
                                <div class="flex-grow-1">
                                    <h6 class="mb-0 fw-bold"><?php echo htmlspecialchars($post['full_name']); ?></h6>
                                    <small class="text-muted"><?php echo date('H:i, d/m/Y', strtotime($post['created_at'])); ?>
                                        <span class="ms-1">· <i class="bi bi-globe"></i></span></small>
                                </div>
                            </div>
                            <div class="card-body py-2 px-4">
                                <div class="mb-3" style="font-size: 0.95rem; line-height: 1.6;">
                            ...
                            <div class="card-footer bg-white border-top border-light py-3 px-4">
                                <div class="d-flex text-muted fw-bold gap-4" style="font-size: 0.85rem;">
                                    <span class="cursor-pointer"><i class="bi bi-heart me-1"></i>
                                        <?php echo $post['like_count']; ?> Tim</span>
                                    <span class="cursor-pointer"><i class="bi bi-chat-left-text me-1"></i>
                                        <?php echo $post['comment_count']; ?> Bình luận</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
                ...
                <form id="profileForm">
                    ...
                    <div class="row align-items-center mb-4 bg-light p-3 rounded-4">
                        <div class="col-md-6 d-flex align-items-center gap-3 border-end border-white">
                            <div style="width:70px;height:70px;"
                                class="rounded-circle overflow-hidden border border-white border-4 shadow-sm flex-shrink-0">
                                <img id="miniAvatarPreview"
                                    src="<?php echo htmlspecialchars($user['avatar_url'] ?? 'https://placehold.co/100x100?text=?'); ?>"
                                    class="w-100 h-100" style="object-fit:cover">
                            </div>
                            <div>
                                <h6 class="mb-1 fw-bold small">Ảnh đại diện</h6>
                                <button type="button" class="btn btn-sm btn-white border rounded-pill shadow-sm"
                                    onclick="document.getElementById('avatarInput').click()"><i
                                        class="bi bi-pencil me-1"></i> Thay đổi</button>
                            </div>
                        </div>
                        <div class="col-md-6 d-flex align-items-center gap-3 ps-4">
                            <div style="width:110px;height:65px;"
                                class="rounded-3 overflow-hidden border border-white border-3 shadow-sm flex-shrink-0">
                                <img id="miniCoverPreview"
                                    src="<?php echo htmlspecialchars($user['cover_url'] ?? 'https://placehold.co/200x100?text=Cover'); ?>"
                                    class="w-100 h-100" style="object-fit:cover">
                            </div>
                            <div>
                                <h6 class="mb-1 fw-bold small">Ảnh bìa</h6>
                                <button type="button" class="btn btn-sm btn-white border rounded-pill shadow-sm"
                                    onclick="document.getElementById('coverInput').click()"><i
                                        class="bi bi-image me-1"></i> Thay đổi</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control rounded-3" name="birthdate"
                                value="<?php echo htmlspecialchars($user['birthdate'] ?? ''); ?>">
                            <div class="form-check mt-2 small">
                                <input class="form-check-input" type="checkbox" name="hide_birthdate"
                                    id="hide_birthdate" <?php echo !empty($user['hide_birthdate']) ? 'checked' : ''; ?>>
                                <label class="form-check-label text-muted" for="hide_birthdate">Ẩn ngày sinh trên trang
                                    cá nhân</label>
                            </div>
                        </div>

                        <div class="col-12 mt-3 pt-3 border-top">
                            <h6 class="fw-bold mb-3 small text-uppercase" style="letter-spacing: 1px;">Liên kết mạng xã
                                hội</h6>
                            <div class="row g-2">
                                <div class="col-md-4">
                                    <div class="input-group input-group-sm rounded-3 overflow-hidden border">
                                        <span class="input-group-text border-0 bg-white px-2"><i
                                                class="bi bi-facebook text-primary"></i></span>
                                        <input type="text" class="form-control border-0" name="link_facebook"
                                ...
                                <div class="col-md-4">
                                    <div class="input-group input-group-sm rounded-3 overflow-hidden border">
                                        ...
                                        <input type="text" class="form-control border-0" name="link_instagram"
                                ...
                                <div class="col-md-4">
                                    <div class="input-group input-group-sm rounded-3 overflow-hidden border">
                                        ...
                                        <input type="text" class="form-control border-0" name="link_tiktok"
                                            placeholder="TikTok URL"
                                            value="<?php echo htmlspecialchars($user['link_tiktok'] ?? ''); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-footer border-0 p-4 pt-0">
                ...
                <button type="button" class="btn btn-primary rounded-pill px-5 fw-bold shadow-sm" id="btnSaveProfile"
                    onclick="handleSaveProfile()">Lưu các thay đổi</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <div class="modal-footer border-top p-4">
                <button type="button" class="btn btn-light rounded-pill px-4" data-bs-dismiss="modal"
                    onclick="handleClearInput()">Bỏ qua</button>
                <button type="button" class="btn btn-primary rounded-pill px-4 fw-bold" id="btnCropSubmit">Áp dụng ảnh
                    này</button>
            </div>
        </div>
    </div>
