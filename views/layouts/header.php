...
<head>
    ...
    <style>
        ...
        .post-modal-body.no-media .post-modal-left {
            display: none;
        }

        .post-modal-body.no-media .post-modal-right {
            flex: 1;
            border-left: none;
        }
            ...
            <div class="top-bar-sticky">
                ...
                <div class="topbar-utility-actions">
                    ...
                    <a href="index.php?action=chat"
                        class="btn btn-light rounded-circle border shadow-sm d-flex align-items-center justify-content-center position-relative"
                        style="width: 40px; height: 40px;" title="Tin nhắn">
                        <i class="bi bi-chat-dots text-muted fs-5"></i>
                        <span class="badge bg-primary rounded-pill position-absolute"
                            style="top:-4px;right:-4px;font-size:0.6rem;display:none;" id="chatBadge">0</span>
                    </a>

                    <!-- Nút Thông báo + Dropdown -->
                    <div class="dropdown">
                        <button
                            class="btn btn-light rounded-circle border shadow-sm position-relative d-flex align-items-center justify-content-center"
                            style="width: 40px; height: 40px;" data-bs-toggle="dropdown" id="notiBtn">
                            <i class="bi bi-bell text-muted fs-5"></i>
                            <span class="badge bg-danger rounded-pill position-absolute"
                                style="top:-4px;right:-4px;font-size:0.6rem;display:none;" id="notiBadge">0</span>
                        </button>
                        <div class="dropdown-menu dropdown-menu-end shadow-lg border-0 p-0 mt-2"
                            style="width:360px;max-height:500px;overflow-y:auto;border-radius:1rem;">
                            <div class="p-3 border-bottom">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <h6 class="mb-0 fw-bold">Thông báo</h6>
                                    <button class="btn btn-sm btn-light border-0 text-primary p-0" id="markAllRead">Đọc
                                        hết</button>
                                </div>
                                <div class="btn-group w-100" role="group">
                                    <button type="button" class="btn btn-sm btn-outline-primary active w-50"
                                        id="btnNotiTask" onclick="event.stopPropagation(); switchNotiTab('TASK')">Công
                                        việc</button>
                                    <button type="button" class="btn btn-sm btn-outline-primary w-50" id="btnNotiSocial"
                                        onclick="event.stopPropagation(); switchNotiTab('SOCIAL')">Mạng xã hội</button>
                                </div>
                            </div>
                    ...
                    <a href="index.php?action=logout"
                        class="btn btn-outline-danger btn-sm rounded-pill px-3 ms-1 shadow-sm d-flex align-items-center gap-2 border-0 bg-danger bg-opacity-10 text-danger fw-600">
                ...
                <div class="modal-dialog modal-dialog-centered modal-xl modal-xl-custom">
                    <div class="modal-content border-0 shadow-lg" style="border-radius: 1rem;">
                        <button type="button"
                            ...
                            data-bs-dismiss="modal" title="Thoát"></button>
