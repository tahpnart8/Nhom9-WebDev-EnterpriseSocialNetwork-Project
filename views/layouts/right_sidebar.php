<aside class="right-sidebar">
    ...
    <!-- Box: Quy định mạng nội bộ (Chỉ hiển thị khi đang ở trang Social) -->
    <?php if (($currentAction ?? '') === 'social'): ?>
    <div class="relioo-card p-4 shadow-sm" style="background: #ffffff; border: 1px solid var(--border-soft);">
...
.urgent-task-number {
    ...
    height: 24px;
    border-radius: 50%;
    background-color: #ef4444; /* red as default */
    color: white;
    font-size: 0.75rem;
    font-weight: bold;
    display: flex;
